...
x=encoded_df.drop(['winner_Chennai Super Kings', 'winner_Delhi Capitals', 'winner_Kings XI Punjab', 'winner_Mumbai Indians', 'winner_Royal Challengers Bangalore', 'winner_Kolkata Knight Riders', 'winner_Rajasthan Royals', 'winner_Sunrisers Hyderabad'], axis=1)
y=encoded_df[['winner_Chennai Super Kings', 'winner_Delhi Capitals', 'winner_Kings XI Punjab', 'winner_Mumbai Indians', 'winner_Royal Challengers Bangalore', 'winner_Kolkata Knight Riders', 'winner_Rajasthan Royals', 'winner_Sunrisers Hyderabad']].values
...
#62 % Accuracy  for random state 33